...
export default function createParaffin() {
    ...
    const handleForm = () => mutate({
        roll_material_id: +rollMaterialId, initial_weight: +initialWeight!, product_id: +productId, type: 'PARAFFIN'
    })
    ...
    return (
        <ThemedView header>
            ...
            <View style={styles.form}>
                ...
                <StyledButton 
                    title='Iniciar Proceso de Impresión'
                    styles={{marginTop: 10}}
                    onPress={handleForm}
                />
            </View>
