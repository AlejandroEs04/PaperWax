...
export default function Index() {
    const [showProductionDowloader, setShowProductionDowloader] = useState(false)
    ...
    const onHide = () => setShowProductionDowloader(false)
    ...
    return (
        <>
            ...
            {showProductionDowloader ? (
                <DownloadButton 
                    onHide={onHide}
                />
            ) : (
                <button 
                    onClick={() => setShowProductionDowloader(!showProductionDowloader)}
            ...
            <div className='mt-6' id='process'>
                ...
                {data?.filter(data => !data.end_time).length ? (
                ...
                <div className='flex justify-between items-end border-b pb-2 mt-10'>
                    <h2 className='text-2xl'>Todos los Procesos</h2>
                </div>
